...
export const OPENINGS = [
  ...
  },
  {
    ...
    description:
      "A solid, resilient opening where Black builds a strong pawn structure. Black develops quietly and aims for a reliable middlegame with counterplay on the queenside.",
    moves: ["e4", "c6", "d4", "d5"],
    tips: [
      "Black prepares to challenge the center with ...d5, supported by the c6 pawn",
      "The pawn structure is more solid than the French — the c8 bishop is not blocked",
      "Black accepts a slower development but gets a very durable position",
    ],
  },
];
