    ...
    examples: [
      {
        ...
        explanations: [
          "White plays Rf8+, sacrificing the rook with check! The king on g8 must respond — and the only way to deal with the check is to capture the rook with Kxf8. The king has been decoyed to f8, a square it normally wouldn't go to. In a real game, this would be followed by a mating attack exploiting the king's exposed position.",
          "The king captures the rook on f8. The decoy worked — the king has been lured away from its safe corner on g8 to the exposed f8 square. In a full game, White would now follow up with checks and threats to mate the exposed king.",
        ],
        result: "The king is decoyed to f8, away from its safe corner. In a real game this would be followed by a mating combination.",
      },
    ],
  },
  "double-check": {
